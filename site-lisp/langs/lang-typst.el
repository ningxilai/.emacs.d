...
(setup (:elpaca typst-preview)
  ...
  (advice-add 'typst-preview--connect-browser :override #'+typst-preview--connect-browser)
  (advice-add 'typst-preview-open-browser :override #'+typst-preview-open-browser)
